...
public class PlaceAPI {
    ...
    public PlaceAPI(String cityLatLon){
    ...
    private static final String API_KEY = "AIzaSyCcTZxZyhS8a0YQTcXUs6baGx0HL1k6GZE";

    public ArrayList<AutoCompleteBean> autocomplete (String input) {
        ...
        try {
            ...
            //sb.append("&location="+39.261134,-76.698773");
            sb.append("&location="+cityLatLon);
            ...
            Log.d("autocomplte","url "+url.toString());
